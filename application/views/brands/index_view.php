...
<div class="tabbable">
    <ul class="nav nav-pills">
        <li class="active"><a href="#tab1" id="tab_main" data-toggle="tab"><i class="icon-th-list"></i> ยี่ห้อสินค้า</a></li>
    </ul>
    <div class="tab-content">
        <div class="tab-pane active" id="tab1">
            <br>
            <blockquote>
                <p>จัดการข้อมูล ยี่ห้อ ทั้งหมดที่มีในฐานข้อมูล</p>
            </blockquote>
            ...
            <div class="modal-body">
                <form action="#" class="form-horizontal">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" id="txt_code" class="col-span-5" placeholder="..." title="ปล่อยว่างเพื่อสร้างอัตโนมัติ">
                        </div>
                    </div>
                    <div class="control-group">
...
<script type="text/javascript" src="<?php echo base_url(); ?>assets/apps/brands.js"></script>
