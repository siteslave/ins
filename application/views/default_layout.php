        ...
        <div class="nav-collapse collapse">
            <ul class="nav">
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <i class="icon-th-list"></i> บริการ
                        <b class="caret"></b>
                    </a>
                    <ul class="dropdown-menu">
                        <li class="nav-header">MAIN SERVICES</li>
                        <li>
                            <a href="<?php echo site_url('services'); ?>"><i class="icon-th-list"></i> รายการซ่อมทั้งหมด</a>
                        </li>
                        <li>
                            <a href="<?php echo site_url('sends');?>"><i class="icon-share"></i> ทะเบียนส่งซ่อมที่อื่น</a>
                        </li>
                        <li>
                            <a href="<?php echo site_url('claims');?>"><i class="icon-share-alt"></i> ทะเบียนส่งเคลม</a>
                        </li>
                        <li class="divider"></li>
                        <li>
                            <a href="<?php echo site_url('services/request');?>"><i class="icon-comments-alt"></i> การร้องขอ (Request)</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <i class="icon-th-large"></i> ข้อมูลพื้นฐาน
                        <b class="caret"></b>
                    </a>
                    <ul class="dropdown-menu">
                        <li class="nav-header">BASIC INFORMATION</li>
                        <li>
                            <a href="<?php echo site_url('products'); ?>"><i class="icon-shopping-cart"></i> ข้อมูลสินค้า</a>
                        </li>
                        <li>
                            <a href="<?php echo site_url('devices'); ?>"><i class="icon-list"></i> ข้อมูลอุปกรณ์อื่นๆ</a>
                        </li>
                        <li>
                            <a href="<?php echo site_url('items'); ?>"><i class="icon-list"></i> ข้อมูลอะไหล่/ค่าบริการ</a>
                        </li>
                        <li>
                            <a href="<?php echo site_url('customers'); ?>"><i class="icon-edit"></i> ข้อมูลหน่วยงาน/ลูกค้า</a>
                        </li>
                        <li class="divider"></li>
                        <li>
                            <a href="<?php echo site_url('admins'); ?>"><i class="icon-share"></i> ข้อมูลผู้ใช้งาน</a>
                        </li>
                        <li>
                            <a href="<?php echo site_url('admins/serials'); ?>"><i class="icon-share"></i> กำหนดรูปแบบรหัส</a>
                        </li>
                        <li class="divider"></li>
                        <li>
                            <a href="<?php echo site_url('types'); ?>"><i class="icon-share"></i> ประเภทสินค้า</a>
                        </li>
                        <li>
                            <a href="<?php echo site_url('brands'); ?>"><i class="icon-refresh"></i> ข้อมูลยี่ห้อ</a>
                        </li>

                        <li>
                            <a href="<?php echo site_url('models'); ?>"><i class="icon-tags"></i> ข้อมูลรุ่น</a>
                        </li>
                        <li>
                            <a href="<?php echo site_url('suppliers'); ?>"><i class="icon-shopping-cart"></i> ข้อมูลบริษัท/ร้านค้า</a>
                        </li>
                        <li class="divider"></li>
                        <li>
                            <a href="<?php echo site_url('companies'); ?>"><i class="icon-globe"></i> ข้อมูลเจ้าของกิจการ</a>
                        </li>
                    </ul>
                </li>
                <li>
                    <a href="<?php echo site_url('reports/history'); ?>"><i class="icon-search"></i> ค้นหาประวัติ</a>
                </li>
                <li>
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <i class="icon-medkit"></i> เครื่องมือ
                        <b class="caret"></b>
                    </a>
                    <ul class="dropdown-menu">
                        <li class="nav-header">BACKUP & RESTORE</li>
                        <li>
                            <a href="<?php echo site_url('admins/backup'); ?>"><i class="icon-cloud-download"></i> สำรองข้อมูล (Backup)</a>
                        </li>
                        <li>
                            <a href="<?php echo site_url('admins/restore'); ?>"><i class="icon-cloud-upload"></i> นำข้อมูลกลับมาใช้ (Restore)</a>
                        </li>
                    </ul>
                </li>
            </ul>
            ...
            if( get_current_name() ) {
                ...
                <ul class="nav pull-right">
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <i class="icon-user"></i> <?=get_current_name()?>
                            <b class="caret"></b>
                        </a>
                        <ul class="dropdown-menu">
