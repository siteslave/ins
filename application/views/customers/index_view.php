<ul class="breadcrumb">
    ...
    <li class="active">ข้อมูลหน่วยงาน/ลูกค้า</li>
</ul>

<div class="tabbable">
    <ul class="nav nav-pills">
        <li class="active">
            <a href="#tab1" id="tab_main" data-toggle="tab"><i class="icon-th-list"></i> ทะเบียนหน่วยงาน/ลูกค้า</a>
        </li>
    </ul>
    <div class="tab-content">
        <div class="tab-pane active" id="tab1">
            <br>
            <blockquote>
                <p>จัดการข้อมูล หน่วยงาน/ลูกค้า ในฐานข้อมูล</p>
            </blockquote>
            <form action="#" class="well well-small">
                <div class="row">
                    ...
                    <div class="col-offset-6">
                        <button class="btn pull-right" type="button" id="btn_export">
    ...
    <div class="modal-dialog" style="width: 960px; left: 35%">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><i class="icon-file"></i> เพิ่มรายการ</h4>
            </div>
            <div class="modal-body">
                <form action="#" class="form-horizontal">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" id="txt_code" class="col-span-3" placeholder="ปล่อยว่างเพื่อสร้างอัตโนมัติ" title="ปล่อยว่างเพื่อสร้างอัตโนมัติ">
                        </div>
                    </div>
                    <div class="control-group">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" id="txt_contact_name" class="col-span-12" placeholder="...">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" id="txt_email" class="col-span-6" placeholder="you@mail.com">
                        </div>
                    </div>
                </form>
            </div>
...
<script type="text/javascript" src="<?php echo base_url(); ?>assets/apps/customers.js"></script>
