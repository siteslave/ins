...
<div class="tabbable">
    <ul class="nav nav-pills">
        <li class="active"><a href="#tab1" id="tab_main" data-toggle="tab"><i class="icon-th-list"></i> กลุ่มครุภัณฑ์</a></li>
    </ul>
    <div class="tab-content">
        <div class="tab-pane active" id="tab1">
            <blockquote>
                <p>จัดการข้อมูล กลุ่มครุภัณฑ์ ทั้งหมดที่มีในฐานข้อมูล</p>
            </blockquote>
            <form action="#" class="form-inline form-actions">

                <label for="txt_query">ค้นหา</label>
                <div class="input-append">
                    <input class="input-xlarge" id="txt_query" type="text" placeholder="พิมพ์ชื่อ หรือ ปล่อยว่างแสดงทั้งหมด...">
...
<script type="text/javascript" src="<?php echo base_url(); ?>assets/apps/groups.js"></script>
