<ul class="breadcrumb">
    ...
    <li class="active">อะไหล่/ค่าใช้จ่าย</li>
</ul>

<div class="tabbable">
    <ul class="nav nav-pills">
        <li class="active"><a href="#tab1" id="tab_main" data-toggle="tab"><i class="icon-th-list"></i> รายการค่าใช้จ่าย/อะไหล่</a></li>
    </ul>
    <div class="tab-content">
        <div class="tab-pane active" id="tab1">
            <br>
            <blockquote>
                <p>จัดการข้อมูล อะไหล่/ค่าใช้จ่าย ทั้งหมดที่มีในฐานข้อมูล</p>
            </blockquote>
        ...
        <div class="modal-content" style="width: 680px;">
            ...
            <div class="modal-body">
                <form action="#" class="form-horizontal">
                    ...
                    <div class="control-group">
                        <label class="control-label" for="txt_price">ราคา</label>
                        <div class="controls">
                            <input type="text" id="txt_price" data-type="number" class="col-span-5" placeholder="...">
                        </div>
                    </div>
                </form>
            </div>
...
<script type="text/javascript" src="<?php echo base_url(); ?>assets/apps/items.js"></script>
