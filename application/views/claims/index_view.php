<ul class="breadcrumb">
    ...
    <li class="active">ส่งเคลมสินค้า</li>
</ul>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <blockquote>
                    ...
                    พิมพ์เลขที่ใบรับซ่อม และ สถานที่ส่งเคลม เพื่อค้นหารายการ หากต้องการเปลี่ยนสถานะเป็นส่งซ่อม ให้คลิกถูกที่ช่องเปลี่ยนสถานะ
                </blockquote>
                <form action="#" class="form-horizontal">
                    <input type="hidden" id="txt_isupdate" value="1">
                    <input type="hidden" id="txt_id" value="">
                    <div class="control-group">
                        <label class="control-label" for="txt_claim_date">วันที่ส่งเคลม</label>
                        <div class="controls">
                            <input class='col-span-2' id='txt_claim_date' data-type="date"
                                   rel="tooltip" title="วันที่ พ.ศ. เช่น 28/02/2556" type='text'>
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input class="col-span-12" id="txt_new_service_code"
                                   type="text" placeholder="เลขที่ใบรับซ่อม">
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="txt_new_service_company_name">สถานที่ส่งเคลม</label>
                        <div class="controls">
                    ...
                    <div class="control-group">
                        <label class="control-label" for="chk_new_send_change_status">เปลี่ยนสถานะ (ส่งเคลม)</label>
                        <div class="controls">
            ...
            <div class="modal-body">
                <form action="#" class="form-horizontal">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input class='col-span-2' data-type="date" id='txt_get_date' type='text'
                                rel="tooltip" title="วันที่ พ.ศ. เช่น 28/02/2556">
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="txt_get_claim_code">เลขที่ใบส่งเคลม</label>
                        <div class="controls">
                            <div class="input-append">
                                <input class="col-span-12" disabled="disabled" id="txt_get_claim_code" type="text" placeholder="...">
                            </div>
                        </div>
                    </div>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <div class="input-append">
                                <input class="col-span-12" disabled="disabled" id="txt_get_service_code" type="text" placeholder="...">
                            </div>
                        </div>
                    </div>
                </form>
...
<div class="modal fade" id="mdl_regemove_get">
    <div class="modal-dialog" style="width: 960px; left: 35%">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h3 class="modal-title"><i class="icon-refresh"></i> ยกเลิกรับกลับสินค้า</h3>
            </div>
            <div class="modal-body">
                <form action="#" class="form-horizontal">
                    ...
                    <div class="control-group">
                        <label class="control-label" for="txt_get_claim_code">เลขที่ใบส่งเคลม</label>
                        <div class="controls">
                            <input class="col-span-12" disabled="disabled" id="txt_remove_claim_code" type="text" placeholder="...">
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="txt_get_service_code">เลขที่ใบรับซ่อม</label>
...
<script type="text/javascript" src="<?php echo base_url(); ?>assets/apps/claims.js"></script>