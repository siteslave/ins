$(function(){
    ...
    suppliers.ajax = {
        ...
        get_detail: function(code, cb){
            var url = '/suppliers/get_detail',
                params = {
                    code: code
                };
    ...
    $('a[data-name="edit"]').live('click', function(){
        ...
        suppliers.ajax.get_detail(code, function(err, data){
            if(err){
                App.alert(err);
            }else{
    ...
    $('a[data-name="remove"]').live('click', function(){
        ...
        if(confirm('คุณต้องการลบรายการนี้ใช่หรือไม่?')){
            suppliers.ajax.remove(code, function(err){
                if(err){
                    App.alert(err);
                }else{
                    //remove row
